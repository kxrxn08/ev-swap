      ...
      <header className="navbar">
        <div className="container nav-inner">
          ...
          <nav className="nav-links">
            <Link to="/" className="nav-link-router">Customer Site</Link>
            <a href="#problem" onClick={scrollTo("problem")}>Problem</a>
            <a href="#discovery" onClick={scrollTo("discovery")}>Discovery</a>
            <a href="#differentiation" onClick={scrollTo("differentiation")}>Why Us</a>
            <a href="#strategy" onClick={scrollTo("strategy")}>Strategy</a>
          </nav>
          ...
          <div className="container hero-grid">
            <div className="hero-content">
              ...
              <div className="hero-actions">
                <a href="#strategy" className="btn btn-primary" onClick={scrollTo("strategy")}>
                  Explore Our Strategy <span>&rarr;</span>
                </a>
                <a href="#discovery" className="btn btn-secondary" onClick={scrollTo("discovery")}>
                  Customer Insights
                </a>
              </div>
            </div>
        ...
        <section className="section animate-in problem-section" id="problem">
          <div className="container">
            ...
            <div className="problem-grid">
              <article className="problem-card">
                ...
                <p>
                  ...
                  the hour, that is lost income they cannot recover.
                </p>
              </article>
              <article className="problem-card">
                <div className="problem-icon">&#128176;</div>
              ...
              <article className="problem-card">
                ...
                <p>
                  A swap station is only useful if it is close to where drivers
            ...
            <div className="problem-takeaway">
              <strong>That is why we are building an alternative.</strong>
              <span>
        ...
        <section className="section animate-in discovery-section" id="discovery">
          <div className="container">
            <div className="section-heading centered">
              ...
              <p>Key findings from early customer discovery interviews.</p>
            </div>
        ...
        <section className="section animate-in funnel-section">
          <div className="container">
            <div className="section-heading centered">
              ...
              <p>Proposed marketing funnel &mdash; metrics to be validated in pilot.</p>
            </div>
          ...
          <div className="container">
            <div className="section-heading centered">
              ...
              <p>
                ...
                bundled batteries &mdash; their stations only work with their own
        ...
        <section className="final-cta" id="contact">
          <div className="container final-cta-inner">
            ...
            <div className="final-actions">
              <a href={WhatsAppLink} className="btn btn-light" target="_blank" rel="noreferrer">
